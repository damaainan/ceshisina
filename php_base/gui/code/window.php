...
$numbersGroup = new Group("Numbers");// numbers 组
...
$openButton = new class("打开文件", $openEntry, $window) extends Button {
...
$saveButton = new class("保存文件", $saveEntry, $window) extends Button {
	public function __construct(string $text, Entry $entry, Window $window) {
		$this->entry = $entry;
		$this->window = $window;
		parent::__construct($text);

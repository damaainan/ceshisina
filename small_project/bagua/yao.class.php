...
class yao
{
    ...
    public function choose($arr, $ben, $bian)
    {
        require "ming.php";
    ...
    //得位
    public function checkWei()
    {}
    //得中
    public function checkZhong()
    {}
...
//产生随机数  应该用更好的扩展
    ...
    public function guaxiang($dayan)
    {
        ...
        // 查 本卦 变卦的名称
        $benx  = array_search(implode('', $bengua), $guaxiang);
        $bianx = array_search(implode('', $biangua), $guaxiang);
        //选择

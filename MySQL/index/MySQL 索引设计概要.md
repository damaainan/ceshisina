...
索引片其实就是 SQL 查询在执行过程中扫描的一个索引片段，在这个范围中的索引将被顺序扫描，根据索引片包含的列数不同，[数据库索引设计与优化][5] 书中对将索引分为宽索引和窄索引：

![Thin-Index-and-Fat-Index][13]
...
![Thin-Index-and-Clustered-Index][14]
...
![Match-Columns-Filter-Columns][18]

过滤列虽然不能够减少索引片的大小，但是能够减少从表中随机读取数据的次数，所以在索引中也扮演着非常重要的角色。

## 索引的设计

作者相信文章前面的内容已经为索引的设计提供了充足的理论基础和知识，从总体来看如何减少随机读取的次数是设计索引时需要重视的最重要的问题，在这一节中，我们将介绍 [数据库索引设计与优化][5] 一书中归纳出的设计最佳索引的方法。
...
1. 第二颗星需要将 ORDER BY 列加入索引中；
1. 第三颗星需要将查询语句剩余的列全部加入到索引中；

> 三星索引的概念和星级的给定来源于 [数据库索引设计与优化][5]>  书中第四章三星索引一节。
...
![Behind-Three-Star-Index][20]

1. 第一颗星不只是将等值谓词的列加入索引，它的作用是减少索引片的大小以减少需要扫描的数据行；
1. 第二颗星用于避免排序，减少磁盘 IO 和内存的使用；
1. 第三颗星用于避免每一个索引对应的数据行都需要进行一次随机 IO 从聚集索引中读取剩余的数据；
...
在单表上对索引进行设计其实还是非常容易的，只需要遵循固定的套路就能设计出一个理想的三星索引，在这里强烈推荐 [数据库索引设计与优化][5] 这本书籍，其中包含了大量与索引设计与优化的相关内容；在之后的文章中读者也会分析介绍书中提供的几种估算方法，来帮助我们通过预估问题设计出更高效的索引。

如果对文章内容的有疑问，可以在博客下面评论留言（评论系统使用 Disqus，需要翻墙）。

> Follow: [Draveness · GitHub][22]
...
* [Inside of Hard Drive - YouTube][24]
* [Hard Disk Working | How does a hard disk work | Hard Drive - YouTube][25]

[0]: http://draveness.me/tag/MySQL
[1]: http://draveness.me/tag/Database
[2]: http://draveness.me/tag/Index
[3]: http://draveness.me/tag/Server
[4]: ../img/2017-09-11-Index-and-Performance.jpg
[5]: https://www.amazon.cn/%E5%9B%BE%E4%B9%A6/dp/B00ZH27RH0
[6]: ../img/2017-09-11-Disk-IO.jpg
[7]: ../img/2017-09-11-Page-DatabaseBufferPool.jpg
[8]: ../img/2017-09-11-Disk-Random-IO.jpg
[9]: ../img/2017-09-11-Disk-IO-Total-Time.jpg
[10]: ../img/2017-09-11-Read-from-Memory.jpg
[11]: ../img/2017-09-11-Sequential-Reads-from-Disk.jpg
[12]: ../img/2017-09-11-Random-to-Sequential.jpg
[13]: ../img/2017-09-11-Thin-Index-and-Fat-Index.jpg
[14]: ../img/2017-09-11-Thin-Index-and-Clustered-Index.jpg
[15]: ../img/2017-09-11-Filter-Factor.jpg
[16]: ../img/2017-09-11-Combined-Filter-Factor.jpg
[17]: ../img/2017-09-11-Same-Columns-Filter-Factor.jpg
[18]: ../img/2017-09-11-Match-Columns-Filter-Columns.jpg
[19]: ../img/2017-09-11-Three-Star-Index.jpg
[20]: ../img/2017-09-11-Behind-Three-Star-Index.jpg
[21]: ../img/2017-09-11-Different-Stars-Index.jpg
[22]: https://github.com/Draveness
[23]: https://dev.mysql.com/doc/refman/5.7/en/innodb-file-space.html
[24]: https://www.youtube.com/watch?v=9eMWG3fwiEU
[25]: https://www.youtube.com/watch?v=4iaxOUYalJU
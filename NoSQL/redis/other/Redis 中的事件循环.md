...
09 Dec 2016[Redis][0][Server][1][Database][2][NoSQL][3]
<font face=微软雅黑>
...
> 有关 Redis 中的 I/O 多路复用模块可以看这篇文章 [> Redis 和 I/O 多路复用][6]> 。

当文件事件触发时会被标记为 “红色” 交由 processEvents 方法处理，而时间事件的处理都会交给 processTimeEvents 这一子方法：

![redis-eventloop-proces-event][7]
...
![eventloop-file-event-in-redis][8]
...
![process-time-events-in-redis][9]
...
* [Redis Event Library][10]
* [Redis Core Implementation][11]
* [Redis 和 I/O 多路复用][6]
* [Redis 设计与实现][12]

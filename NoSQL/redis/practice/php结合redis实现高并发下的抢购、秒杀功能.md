# [php结合redis实现高并发下的抢购、秒杀功能][0]

 标签： [高并发][1][秒杀][2][抢购][3][redis队列][4]

 2016-07-09 10:09  20632人阅读  
...
再如上面的会导致一个用户抢多个，思路：  
需要一个排队队列和抢购结果队列及库存队列。高并发情况，先将用户进入排队队列，用一个线程循环处理从排队队列取出一个用户，判断用户是否已在抢购结果队列，如果在，则已抢购，否则未抢购，库存减1，写[数据库][10]，将用户入结果队列。
...
[0]: /nuli888/article/details/51865401
[1]: http://www.csdn.net/tag/%e9%ab%98%e5%b9%b6%e5%8f%91
[2]: http://www.csdn.net/tag/%e7%a7%92%e6%9d%80
[3]: http://www.csdn.net/tag/%e6%8a%a2%e8%b4%ad
[4]: http://www.csdn.net/tag/redis%e9%98%9f%e5%88%97
[9]: #
[10]: http://lib.csdn.net/base/mysql
[11]: http://lib.csdn.net/base/softwaretest
# Redis内部数据结构详解(1)——dict
 ...
 时间 2016-05-31 09:30:00  铁蕾的个人博客

原文[http://zhangtielei.com/posts/blog-redis-dict.html][1]
...
第一个层面的“数据结构”，Redis的官方文档( [http://redis.io/topics/data-types-intro][4] )有详细的介绍。本文的重点在于讨论第二个层面，Redis数据结构的内部实现，以及这两个层面的数据结构之间的关系：Redis如何通过组合第二个层面的各种基础数据结构来实现第一个层面的更高层的数据结构。 
...
**原创文章，转载请注明出处！****本文链接：**[http://zhangtielei.com/posts/blog-redis-dict.html][6]


[1]: http://zhangtielei.com/posts/blog-redis-dict.html

[4]: http://redis.io/topics/data-types-intro
[5]: ./img/nQBFnau.png
[6]: http://zhangtielei.com/posts/blog-redis-dict.html
# JS正则表达式完整教程（略长）
 ...
 时间 2017-07-12 14:24:16  [稀土掘金][00]

_原文_[https://juejin.im/post/5965943ff265da6c30653879][01]

 主题 [正则表达式][02][JavaScript][03]
...
首先，我们知道， `\w` 是字符组 `[0-9a-zA-Z_]` 的简写形式，即 `\w` 是字母数字或者下划线的中任何一个字符。而\W是排除字符组 [^0-9a-zA-Z_] 的简写形式，即 `\W` 是 `\w` 以外的任何一个字符。 

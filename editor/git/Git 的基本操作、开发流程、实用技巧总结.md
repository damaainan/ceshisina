...
![git log --stat 可以让你的 commit 记录更清晰][2]
...
✦ Feature分支：某个功能的分支，从 Develop 分支切出，并且功能完成时又合并回 Develop 分支，不直接和  
Master 分支交互。  
...
当然 GitFlow 有一些辅助工具 [gitflow][8] 可以自动化的完成这些任务，对于大型项目也很有帮助。
